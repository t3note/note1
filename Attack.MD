...
- 申请一台带公网IP的公有云服务器hostb，我们假设ip地址是12.34.56.78，在hosta上执行下面的命令，它会建立一个从hosta到hostb的ssh会话，同时将8080端口映射到hostb的1080端口。`ssh -R 1080:localhost:8080 root@12.34.56.78`, 这样，小王就可以愉快的用http://12.34.66.78:1080访问小明的服务了。
